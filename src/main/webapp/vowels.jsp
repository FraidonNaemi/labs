<%-- 
    Document   : vowels
    Created on : Nov 24, 2022, 11:44:26 AM
    Author     : 236339
--%>
...
<html>
    ...
    <body>
        ...
        <table class="table vowel-table table-bordered table-striped" style="display: inline-block">
            <thead class="table-head"><th style="min-width:120px">Vowels</th><th>Frequencies</th></thead>           
            <tr> 
                <td>A: </td>
                <td><%= frequencyA(s)%></td>
            </tr>
